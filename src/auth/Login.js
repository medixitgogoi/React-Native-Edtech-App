                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1, paddingTop: 40, paddingHorizontal: 5 }}>
                    ...
                    <TextInput
                        ...
                        style={{
                            ...
                            marginBottom: 20,
                            borderColor: isMobileFocused ? lightBlue : '',
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#1c1c1c', borderRadius: 8, borderColor: isPasswordFocused ? lightBlue : '', borderWidth: isPasswordFocused ? 1 : 0, paddingHorizontal: 10, marginBottom: 5 }}>
                        <TextInput
                    ...
                    >
                        <Text style={{ color: lightBlue, textAlign: 'right', marginBottom: 30, fontSize: responsiveFontSize(1.5), fontWeight: '600' }}>Forgot Password?</Text>
                    </TouchableOpacity>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'center', marginBottom: 20, alignItems: 'flex-end' }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('OtpVerification', { to: 'signup' })}>
                            <Text style={{ color: lightBlue, fontSize: responsiveFontSize(1.7), fontWeight: '600' }}>Sign Up</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </KeyboardAvoidingView>
